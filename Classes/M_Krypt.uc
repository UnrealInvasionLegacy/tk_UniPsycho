class M_Krypt extends tk_Monster 
	config(tk_Monsters);
...
defaultproperties
{
     ...
     IdleWeaponAnim="idle_chat"
     Mesh=SkeletalMesh'tk_UniPsycho.UniPsycho.KryptMesh'
     Skins(0)=Texture'tk_UniPsycho.UniPsycho.Krypt_BodyTex'
     Skins(1)=Texture'tk_UniPsycho.UniPsycho.Krypt_HeadTex'
     Skins(2)=Texture'tk_UniPsycho.UniPsycho.Krypt_unicycleTex'
     Skins(3)=Texture'tk_UniPsycho.UniPsycho.Krypt_StoneTex'
     Mass=150.000000
     Buoyancy=150.000000
